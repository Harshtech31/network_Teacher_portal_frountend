...
const EditEvent = () => {
  ...
  if (!canEdit) {
    return (
      <div className="text-center py-12">
        <h3 className="text-lg font-medium text-gray-900">Cannot edit event</h3>
        <p className="mt-1 text-sm text-gray-500">
          This event cannot be edited because it has already started or has been cancelled.
        </p>
        <div className="mt-4">
          <button
      ...
      {event.status === 'rejected' && (
        <div className="bg-red-50 border border-red-200 rounded-md p-4">
          <p className="text-sm text-red-800">
            <strong>Note:</strong> This event was previously rejected. Making changes will resubmit it for approval.
          </p>
        </div>
      )}
            ...
            <div className="card">
              ...
              <div className="mt-4 p-3 bg-blue-50 rounded-lg">
                <p className="text-xs text-blue-800">
                  <strong>Note:</strong> Changes will be saved and may require re-approval depending on the modifications made.
                </p>
              </div>
            </div>
          </div>
